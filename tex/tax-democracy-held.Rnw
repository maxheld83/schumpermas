\documentclass[11pt,a4paper,openright,oneside,titlepage,english]{book}
...
\frontmatter
	...
	\input{./source/acronyms.tex}
	\begin{document}
	\maketitle
	\input{./source/title-page-phd.tex}
	\setcounter{page}{3}
	%\input{./tex/dedication-phd}
	\chapter*{Abstract}
		\label{chap:abstract}
		\immediate\write18{pandoc ABSTRACT.md -t latex -o Output/tmp.tex} % markdown -> tex
		\input{Output/tmp.tex} % include tex
	\chapter*{About This Document}
		\label{chap:how2}
		\input{./source/how2.tex}
	\tableofcontents
	\listoffigures
	\listoftables
