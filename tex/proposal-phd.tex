...
I here propose to probe into one intersection of legitimate inputs and outputs of the social contract \citep[compare][]{Scharpf1997}: the discourse \emph{on}, and economics \emph{of} tax.
...
Tax matters especially true for current \gls{OECD}-style welfare regimes, in which markets and states must co-exist \citep{Stiglitz2011}.
...
A dysfunctional mixed economy without good taxes may produce illegitimate outputs, and, in so far as it disturbs the state-market balance of the mixed economy, violate output congruence \citep[compare][190]{Zurn-2000-aa}. 
...
These metaphysical conundrums are reflected in very concrete, technocratic issues in taxation, including \glspl{DWL} (p.~\pageref{sec:tax-optimality}), \hyperref[sec:diminishing-marginal-utility]{diminishing marginal utility} (p.~\pageref{sec:diminishing-marginal-utility}), the \hyperref[des:structural-agnosticism]{treatment of capital income} (p.~\pageref{sec:structural-agnosticism}), or \hyperref[sec:love-marriage]{joint spousal taxation} (p.~\pageref{sec:love-marriage}), respectively. 
Likewise, experts cannot justify the axioms on which their (economic) analyses rest: whether, and under which institutional circumstances we are homines oeconomici (\autoref{chap:wanted}, p.~\pageref{chap:wanted}), cannot be exhaustively answered from observation, because nature offers no intelligible moral messages on what kind of man we \emph{should} be \citep[43]{Gould1982}.
...
\begin{enumerate}
	...
	\item orientation on the \emph{common good} \cite{Rawls-1971},
	%	\footnote{
	...
	\item \emph{authenticity} in sincere, not strategic communication \citep[149]{Habermas-1983},
\end{enumerate}
...
The \gls{DQI} --- even in \citeauthor{Steenbergen2003}'s more exacting formulation --- and other such operationalizations ``can be applied easily and reliably to a wide range of deliberative contexts'' \citep[22]{Steenbergen2003}, but that very decontextualization makes it hard to adjudicate whether really, universal validity was reciprocally acclaimed. 
...
It is much harder to see how their dialogue would proceed; presumably, Foundationalist would not --- ex ante --- have been open to large-scale land reform, and may not warm to the idea.
...
Still, to thereby ``simply define'' deliberation as ``intrinsically good'' does not, as \citealt[524]{Mutz2008} suspects, does not render ``empirical research irrelevant''.
...
We can and should avoid choosing either of these approaches exclusively'' \citep[90]{GutmannThompson-2004-aa}.
Consequently, researchers need not take sides, nor follow dubious expert rule \citep{Blok2007,Haas1992}.
...
To test whether people in any given deliberation on tax really have exchanged universal validity claims to --- potentially --- resolve these disagreements, their actual communication must be compared to some ideal standard of expected arguments, provisionally identified by researchers.
...
Based on his sobering findings, \cite[20]{Rosenberg-2007-aa} also suggests a revised understanding of deliberation:

\begin{quote}
	``Deliberative fora must not be regarded simply as empty stages that provide a venue for the realization of citizenship; nor must the design of these deliberative stages focus simply on the removal of obstructions that may inhibit freedom or give unequal scope for maneuver. 
...
This ``reforming'' variant of \citeauthor{Habermas-1984-aa}' vision, informed by empirical facts about our time, and our people, also bears on the analysis and operationalization of deliberation.
...
A small, self-selected sample of 12-15 diverse citizens will attend 8-10 days of learning and deliberation spread over several weeks. 
...
\input{./tex/validity-claims-tax.tex}
    ...
    \item \label{itm:think-different}
		...
		\begin{enumerate}
			...
			\item \label{itm:knowledge-gain}
				...
				Specifically relevant for tax choice (\autoref{fig:tax-with-misunderstandings}, p.~\pageref{fig:tax-with-misunderstandings}), %not working
				\begin{enumerate}
...
%
%Rosenberg 2007: %Deliberation (12) "should not be conceived sumply as settings for free exchange in which citizens capacities for reflecton and engagement can be realized. " "[t]he research suggests that deliberations be regarded as remedial institutions."
...
%
%Gutman Thompson The viability and legitimacy of the liberal-democratic project may turn on the answer. HowRead more at location 1431