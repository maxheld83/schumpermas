...
\section[Incidence]{Incidence: Doable Taxes Exert Well-Defined Burdens} \label{sec:incidence}
...
\paragraph{Love and Marriage\ldots} \phantomsection \label{sec:LoveMarriage}\nopagebreak
\begin{quote}
...
\section[Elasticity]{Elasticity: Doable Taxes Hardly Alter Economic Exchanges} %{\emph{How} to Tax? ---\\Taxing Inelastic Bases Minimizes DWLs} \label{sec:TaxInelastic} 
...
\section[Timing]{Timing: A Doable Tax Falls on Liquid Goods} \label{sec:timing} %worry: is this maybe yet another subset of a DWL problem?
...
\begin{desideratum}[Agnostic Towards Labor and Capital Incomes]
	...
	\label{des:StructuralAgnosticism}
\end{desideratum}
