...
Under the \emph{difference principle}, differences in endowments as well as subsequent social and economic inequalities are acceptable only if their granting also benefits the least fortunate\footnote{
	\citeauthor{Rawls-1971-aa} (\citeyear{Rawls-1971-aa}: 122) warns that this calculus must not only include strictly economic payoffs, but must also take into account the intangible correlates of social inequality as societal and cultural participation, as well as confidence.}. 
...
\paragraph{Why Rawls?} 
Any comprehensive discussion of distributional justice is beyond the scope of this thesis. \citeauthor{Rawls-1971-aa} \emph{Theory of Justice} is presented here for four reasons.
...
Thirdly, in arguing that the PCT is the perfect tax, I attempt to establish it as an \emph{reflective equilibrium} (\citealt{Rawls-1971-aa}: 49) emerging from a pragmatic-spirited back-and-forth between what is \hyperref[sec:desirability]{desirable}, and what is \hyperref[sec:feasibility]{doable} (\citealt{McCaffery2005}: 856).

Fourth, \citeauthor{Rawls-1971-aa}' \emph{Theory of Justice} (\citeyear{Rawls-1971-aa}) is an end-state theory of distributive justice (\citealt{Fried1999}: 1007), not a procedural prescription (for example \citealt{Dahl-1989-aa}). This thesis, likewise, hypothesizes a normatively superior allocative outcome (``Is this the best of all \ldots'', c.f. page \pageref{sec:Wanted}). A political process, aside from \citeauthor{Rawls-1971-aa}ian liberty, is not prescribed in its own right. It merely serves as an \emph{independent} variable in \autoref{sec:WhyNot}, explaining and criticizing why it may have failed to deliver the superior allocative outcome.
...
Two desiderata for tax design emerge from \citeauthor{Rawls-1971-aa}'s Theory of Justice. 
...
\section[Sustainability]{Sustainability: A Desirable Tax Ensures Future Prosperity} \label{sec:sustainability}%definietely need better title
