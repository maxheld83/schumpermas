...
\footnote{
	...
	\begin{quote}
		...
		(\ldots) Anyone watching from Mars would be scratching their head.''}
	\end{quote}
}
\begin{enumerate}
...
%
%\subparagraph{Broad Ownership is Great for Incentivizing Work} Particularly in situations where asymmetric information on work performance abounds, sufficient wealth is required to make workers stakeholders in an effort to overcome incentive problems \marginpar{\textsf{(Cite game theoretic literature here, ask Professor Gr\"uner for more stuff.)}}.
