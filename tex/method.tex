...
%Notice that I also can't do Mises in tax b/c he rejects the very notion as to other anarcho-liberals.
	%Same with with marx, only other way
	%this might be done in a lter q-sort, with another focus (and it should be!) In many ways, this is the special case before the general case.
%look into böhm-bauwerk on savings norms
