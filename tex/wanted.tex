...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item
		Hypothetical well-being, reported as the hedonic gain or loss ascribed \emph{to} some non-outcome.
		\footnote{
...
\footnote{
	This problem also plagues public/social choice and finance:
...
They, and the \hyperref[sec:sources-of-wealth]{sources of wealth} (p.~\pageref{sec:sources-of-wealth}) they tap into are the \emph{only known} way to prosperity.
