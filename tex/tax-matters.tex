...
\gls{eu} tax competition is a \gls{pd}, where states (strictly) dominantly prefer low taxes over high taxes and (Nash) equilibriate in suboptimal, mutual low taxation (\autoref{tab:Tax-PD}) on \autopageref{tab:Tax-PD}).
