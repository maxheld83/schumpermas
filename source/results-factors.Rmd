...
This postulated incomparability applies to this study, too, and plays out in several ways:
 ...
 1. *Generalizeability & Small N Design.*
  ...
  3. *Validity & Research Ethics.*
    ...
    <!-- notice that the above, even *inductive* hypothesizing is *in terms* of how the items were originally conceived, not so much in terms of subjectiv*ies* that people impressed on them -->
    <!-- maybe sth about operant nature? -->

    <!-- TODO this is about the LGO houses, not individual bricks - so it makes no sense -->


<!-- I'm not against R (a little bit though) -->
...
<!-- Looking into the descriptives --- or any other R work, would, at best be a waste of effort, and at worst, strictly unscientific. -->
