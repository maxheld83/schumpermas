...
# notice this actually is based on pearson cor coeff, because prcomp uses it, otherwise inconsistent, it is JUST TO ILLUSTRATE!
eigen.examples["positive",2]
do.call("grid.arrange", c(t(eigen.examples[,c(4,6)]), list(nrow = 4, ncol = 2)))
do.call("grid.arrange", c(t(eigen.examples["positive",c(4,6)]), list(nrow = 1, ncol = 2)))
```
