...
### Principal Components Analysis (what does it do)

Principal Components Analysis then appears the most appropriate data reduction technique for this study, if not Q methodology in general.
Because it is relatively easy to describe, unfamiliar for a correlation matrix of people-variables and provides the basis for all of the following analysis, I explain the procedure in some detail and with reference to my data.
