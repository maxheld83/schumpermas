...
By contrast, consider the below, spurious eigenvalue decomposition of `r eigen.examples[["identity","pairs"]][1]` with herself in linear and matrix algebra notation.
...
Extracting *too many* factors leaves you with spurious viewpoints which, at best, are only marginally more expressive than an individual Q sort, and, at worst, spurious amalgams of quite *different* Q sorts, all mixed together, as in the analogous "car-house" building manual.
Extracting *too few* factors, at best, you needlessly loose nuance in people's viewpoints, and, at worst, you may disregard people's subjectivity by (through rotation) subsuming them under overly broad factors.

Much of the Q literature appears to treat this choice as *methodological* issue, to be decided based on their downstream merit for factor interpretation, and generally gives the alternative criteria short shrift.
<!-- TODO add source -->
...
Alternately *shared* viewpoints on taxation and the economy are primarily a *positive*, even *falsifiable* question, notwithstanding the need for downstream abductive interpretation.
