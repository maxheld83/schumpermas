...
[^small_households]: Changing household sizes are often overlooked in critical accounts of income inequality, though it is unclear whether we can really take much solace in supposedly exogenous smaller, poorer households.
...
<!-- VK:  You don't need the last sentence. The reader knows what libertarians want. Go on with the next one.-->
...
We should interrogate our present situation through both these ideological lenses
<!-- VK: which lenses? (repeat it)-->
--- and any other viewing aids not neatly foldable into these two camps --- if only to be aware of our blindspots, and perhaps, even to expand our moral horizons.
...
1. To falsifiably assess our present situation, we require a reliable point of comparison.
  Many of the above diagnoses, sometimes implicitly, but often explicitly (as longitudinal trends and the like) choose a point in the past as a reference against which to compare the present.
  This, alas, does not make for a rigorous research design, because in the past, all other things were emphatically *not* equal, including the context and operationalisation of variables.
...
To make a falsifiable, empirical assertion about the imperfection of our present situation would require a reliable point of comparison, typically in the recorded past ("post-democracy") or an imagined future ("late capitalism"), but at this point in time, all other things were emphatically *not* equal, including the context and operationalization of variables.
