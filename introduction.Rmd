...
However, because the study deals not with easily measurable biomarkers, but with subleties of deliberation and the abstractions of text, the design can be hard to recognize.
...
[^no-rct]: Proper experimental designs are often double-blind *randomly controlled trials* (RCT), but these additional rigors are not possible or deemed unecessary for the present study on deliberation and taxation:

  - A fully **randomised treatment** is impossible, because participants in a deliberative forum will (and should) always be free to exit the sample.
...
<!-- TODO ... is that the right reference? -->
  ...
  In any event, there were no expected background events or trends affecting the subjectivities concerning taxation of *both* treatment and control groups, so a control group was deemed dispensible.
...
She also finds two other studies with similar treatments, one even flew participants out to a carribean yoga retreat.
The remaining supervisors stay on, perhaps just hoping that the philosophising will now come to an end, and the study reach firmer ground.
...
<!-- TODO add plot here where/how these chapters feed into other objects/chapters, to really drive home how necessary they are. -->
