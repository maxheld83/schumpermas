...
At least for now, and albeit threatened by a barrage of geopolitical risks and global imbalances, our planetary market economy continues to produce marvels of material prosperity.
...
These mainstream economic indicators are highly imperfect [^bad_gdp], but they  they suggest that far from collapsing under the weight of its ostensible internal contradictions, capitalism is still humming along.
...
Income and wealth inequality are rising, though some of that widening gap may be driven by smaller household sizes.[^small_households]
...
At the same time, the institution traditionally tasked with reigning in the economy, the modern welfare state, appears severely constrained in its ability to redistribute market outcomes, to fund public goods and to internalise externalities.
...
[^small_households]: Changing household sizes are often overlooked in critical accounts of income inequality, though it is unclear whether we can really take much solice in supposedly exogenous smaller, poorer households.
...
New technologies, from cheap and easy web publishing to social media to distributed software systems have made it possible for ever greater numbers of citizens to make their voices heard, to organise themselves and to challenge existing institutions and incumbents.
...
Voters appear to become more polarised, at least in some countries, and at some level of government.
...
Critical social scientists, from @Marx-1867-aa to today's gloomy pronouncers of "post-democracy" [@Crouch2004] and "late capitalism" [@mountford2011], respond by highlighting the inherent contradictions of current economic and social arrangement, and contrasting a deplorably imperfect present reality against supposedly achievable utopias past or future [also see @Streeck2013; @NachtweyAbstiegsgesellschaftUberAufbegehren2016].
This ambition to mold evolved institutions, and sometimes human behavior itself, to birth a better world may have provided, if sometimes in a roundabout way, the emancipatory impetus for many progressive achievements, such as Bismarckian social insurance or universal suffrage but has also fueled the hybris of social planners [see @SpuffordRedPlenty2011], and is associated with the evils of 20th century left authoritarianism [@Hayek1944; but compare @arendt_origins_1973].
<!-- TODO add meta reference to Bismarck -->

By contrast, conservative and libertarian observers, from @Burke1790 and @Hayek-1960 to modern-day critics of democratic rule [@Caplan2007], liberal multiculturalism [@haidt_righteous_2012], rentier capitalism [@zingales2014capitalism] and economic consequentialism [@McCloskeyBourgeoisVirtuesEthics2006], wish not to demand *more* of coercive institutions and human nature, but *less*.
From this vantage point, whatever crises we may face --- if any ---, are perhaps the result of an overextended state and overly inclusive polity, crumbling under the weight of its unkept promises and collective action dysfunctions. 
<!-- TODO these aren't very good "zeitdiagnosen", they are actually much better than that. so it's a weird comparison. -->
These viewpoints, regrettably ignored or disavowed in much of the social sciences, call for healthy skepticism of man-made societal designs and urge us to respect the wisdom contained in evolved, and therefore stable institutions.
...
We should interrogate our present situation through both these ideological lenses --- and any other viewing aids not neatly foldable into these two camps --- if only to be aware of our blindspots, and perhaps, even to expand our moral horizons.

However, neither of these approaches are 1) scientific pursuits in a narrow, empirical sense or 2) terribly specific about how to go on from here.
...
1. To make a falsifiable, empirical assertion about the imperfection of our A falsifiable, empirical assertion about our present situation would require a reliable point of comparison, typically in the recorded past, but at this past point in time, all other things were emphatically *not* equal, including the context and operationalisation of variables.
  This limitation is easiest to illustrate for quantitative comparisons, but may extend to qualitative data by analogy.
  
  
  Oddly, though most critical diagnoses are not strictly quantitative, few can resist dropping in the occasional, cherry-picked statistic [but compare @Crouch2004].
  

critical analysis of our present situation always requires a point of comparison, typically in the recorded past ("post-democracy") or an imagined future ("late capitalism").
  This is often 
